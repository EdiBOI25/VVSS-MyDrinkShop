...
public class DrinkShopServiceImpl implements DrinkShopService {
    ...
    public DrinkShopServiceImpl(
        ...
        this.orderService = new OrderServiceImpl(orderRepo, productRepo);
        this.retetaService = new RetetaServiceImpl(retetaRepo);
        this.stocService = new StocServiceImpl(stocService);
